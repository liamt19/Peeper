...
namespace Peeper.Logic.UCI
{
    public class USIOption
    {
        ...
        public USIOption(string name, string type, string defaultValue, FieldInfo fieldHandle)
        {
            Name = name;
            Type = type;
        ...
        {
            return "option name " + DisplayName + " type " + Type + " default " + DefaultValue + (FieldHandle.FieldType == typeof(int) ? (" min " + MinValue + " max " + MaxValue) : string.Empty);
        }
    }
}